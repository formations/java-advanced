...
https://github.com/sodant/java8workshop/tree/master/JFall%20Hands-On/java8-hands-on-jfall-2014[Lab Xebia à JFall 2014^]::
Réaliser les exercices du dossier JFall Hands-On en suivant les instructions données sur Github.
